...
<head>
  ...
  <!-- FONTS -->
  <link rel="stylesheet" href="../assets/fonts/Coves_Typeface/stylesheet.css" media="screen" title="no title" charset="utf-8">
        ...
        <div class="row navbar">
            <div class="col-md-offset-1 col-md-10 zone_navbar">
                ...
                <div class="col-md-4 items_2">
                    <ul>
                        <li>
                            <a href="" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Log In</a>
                        </li>
                        <li>
