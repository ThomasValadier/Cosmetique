...
<div class="col-md-offset-1 col-md-10 titre-page-categorie">
    <h1>peaux grasses</h1>
    <a href="../views/categorie_detail.php?resultatTest=1">
...
<div class="col-md-offset-1 col-md-10 zone_produit">
    ...
    <?php $produits = $DB->query('SELECT * FROM produits WHERE resultatTest = 1 AND produit_actif = 1'); ?><!-- affichage que si le produit est actif-->
...
<div class="col-md-offset-1 col-md-10 titre-page-categorie">
    <h1>peaux mixtes à grasses</h1>
    <a href="../views/categorie_detail.php?resultatTest=2">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
    </a>
</div>
...
<div class="col-md-offset-1 col-md-10 zone_produit">
    ...
    <?php $produits = $DB->query('SELECT * FROM produits WHERE resultatTest = 2 AND produit_actif = 1'); ?>
    <?php foreach ($produits as $produit): ?>
...
<div class="col-md-offset-1 col-md-10 titre-page-categorie">
    <h1>peaux sèches & déshydratées</h1>
    <a href="../views/categorie_detail.php?resultatTest=3">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
    </a>
</div>
...
<div class="col-md-offset-1 col-md-10 zone_produit">
    ...
    <?php $produits = $DB->query('SELECT * FROM produits WHERE resultatTest = 3 AND produit_actif = 1'); ?>
    <?php foreach ($produits as $produit): ?>

        <div class="box_produit">
            <div class="row zone_image">
                <a href="produit.php?id_produit=<?= $produit->id_produit; ?>"><img class="img-responsive" src="../assets/images/upload/<?= $produit->image; ?>"></a>
            </div>
            <div class="row zone_description">
                <p><?= $produit->nom_produit; ?></p>
            </div>
...
<!-- CATEGORIE : SOIN POUR LE CORPS -->
<div class="col-md-offset-1 col-md-10 titre-page-categorie">
    <h1>peaux sensibles</h1>
    <a href="../views/categorie_detail.php?resultatTest=4">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
    </a>
</div>
...
<div class="col-md-offset-1 col-md-10 zone_produit">
    ...
    <?php $produits = $DB->query('SELECT * FROM produits WHERE resultatTest = 4 AND produit_actif = 1'); ?>
    <?php foreach ($produits as $produit): ?>
