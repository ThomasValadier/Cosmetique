...
if (isset($_POST['connexion']))
{
    if (!empty($_POST['pseudo']) && !empty($_POST['password']))
    {
        ...
        $user_connexion = $DB->requete("SELECT id_user, identifiant_user, password_user, resultatTest_user, is_admin FROM users WHERE identifiant_user = '$user_identifiant'");
        ...
        if ($user_connexion->identifiant_user == $_POST['pseudo'])
        {
            ...
            if ($user_password == $user_connexion->password_user)
            {
                ...
                $_SESSION['session'] = array(
                    ...
                    'resultatTest' => $user_connexion->resultatTest_user
